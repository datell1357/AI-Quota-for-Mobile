...
### 한 줄 요약
AI Usage for Windows가 PC에서 Codex, Claude, Gemini, GitHub Copilot 구독 plan 사용량을 수집하고, iOS/Android 앱과 위젯이 Firebase를 통해 최신 usage snapshot을 확인하는 모바일 동기화 기능입니다.
...
- iOS/Android 위젯으로 Codex, Claude, Gemini, GitHub Copilot 사용량을 빠르게 확인합니다.
...
### 주요 사용자
- **누구**: Codex, Claude, Gemini, GitHub Copilot 등 AI 코딩/LLM 구독을 여러 개 쓰는 사용자
...
- [ ] PC device upload 인증을 custom auth token 방식으로 할지, Cloud Functions callable-only 방식으로 할지 결정
