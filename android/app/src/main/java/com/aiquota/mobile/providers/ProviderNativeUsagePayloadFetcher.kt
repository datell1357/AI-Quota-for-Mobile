...
object ProviderNativeUsagePayloadFetcher {
    fun bridgeUsagePayload(providerId: ProviderId): String {
        ...
        if (providerId == ProviderId.GEMINI) {
            return GoogleWebSessionCodeAssistFetcher.bridgeUsagePayload(providerId)
        }
    ...
    private val EMAIL_KEYS = setOf("email", "account_email", "accountemail", "user_email", "useremail")
