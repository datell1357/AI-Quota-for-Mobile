...
class ProviderLoginUrlRewriterTest {
    ...
    @Test
    fun doesNotRewriteGeminiGoogleAccountUrls() {
    ...
    @Test
    fun geminiLoginStartsWithNativeOauthRoute() {
        ...
        assertTrue(geminiDefinition.contains("loginStartUrl = \"aiquota://provider/gemini-oauth\""))
