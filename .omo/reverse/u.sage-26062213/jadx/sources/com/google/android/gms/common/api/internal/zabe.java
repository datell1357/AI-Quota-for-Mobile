...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    private final void zal(int i) {
        ...
        if (num == null) {
            ...
            q73.n("Cannot use sign-in mode: ", zag(i), ". Mode was already set to ", zag(this.zaw.intValue()));
            return;
        }
        if (this.zal != null) {
            return;
        ...
        if (iIntValue == 1) {
            zabeVar = this;
            if (!zRequiresSignIn) {
                k21.n("SIGN_IN_MODE_REQUIRED cannot be used on a GoogleApiClient that does not contain any authenticated APIs. Use connect() instead.");
                return;
            } else if (zProvidesSignIn) {
                k21.n("Cannot use SIGN_IN_MODE_REQUIRED with GOOGLE_SIGN_IN_API. Use connect(SIGN_IN_MODE_OPTIONAL) instead.");
                return;
            }
        } else {
    ...
    @Override // com.google.android.gms.common.api.GoogleApiClient
    public final void stopAutoManage(qc1 qc1Var) {
        LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) qc1Var);
        if (this.zam >= 0) {
            zak.zaa(lifecycleActivity).zae(this.zam);
        } else {
            k21.n("Called stopAutoManage but automatic lifecycle management is not enabled.");
        }
    }
