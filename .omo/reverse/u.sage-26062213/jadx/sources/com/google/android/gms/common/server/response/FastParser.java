...
public class FastParser<T extends FastJsonResponse> {
    ...
    */
    ...
    private final void zaw(int i) throws ParseException {
        if (this.zat.isEmpty()) {
            throw new ParseException(xw1.q("Expected state ", i, " but had empty stack"));
        }
        int iIntValue = ((Integer) this.zat.pop()).intValue();
        if (iIntValue != i) {
            throw new ParseException(di0.p(i, iIntValue, "Expected state ", " but had "));
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:132:0x025c A[SYNTHETIC] */
