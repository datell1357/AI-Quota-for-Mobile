        ...
        try {
            ...
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    ...
                    String strV = di0.v("Activity not found while launching ", pendingIntent.toString(), ".");
                    if (Build.FINGERPRINT.contains("generic")) {
                        strV = strV.concat(" This may occur when resolving Google Play services connection issues on emulators with Google APIs but not Google Play Store.");
                    }
                    Log.e("GoogleApiActivity", strV, activityNotFoundException);
                }
                googleApiActivity.zaa = 1;
