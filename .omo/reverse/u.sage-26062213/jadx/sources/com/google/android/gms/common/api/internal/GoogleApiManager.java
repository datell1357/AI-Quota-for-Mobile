...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final Set zap = new fi(0);
    private final Set zaq = new fi(0);

    private GoogleApiManager(Context context, Looper looper, GoogleApiAvailability googleApiAvailability) {
        this.zas = true;
        this.zai = context;
        fj4 fj4Var = new fj4(looper, this);
        this.zar = fj4Var;
        ...
        fj4Var.sendMessage(fj4Var.obtainMessage(6));
    }
    ...
    private final void zaJ(pw3 pw3Var, int i, GoogleApi googleApi) {
        zacd zacdVarZaa;
        ...
        ef5Var.getClass();
        ef5Var.b.b(new n25(executor, zacdVarZaa));
        ef5Var.s();
    }
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i) {
            ...
            case 5:
                ...
                if (zabqVar == null) {
                    Log.wtf("GoogleApiManager", xw1.q("Could not find API instance ", i2, " while trying to fail enqueued calls."), new Exception());
            ...
            case 14:
                ...
                if (this.zan.containsKey(apiKeyZaa)) {
                    zaafVar.zab().b(Boolean.valueOf(((zabq) this.zan.get(apiKeyZaa)).zaO(false)));
                } else {
                    zaafVar.zab().b(Boolean.FALSE);
                }
                return true;
            case 15:
    ...
    public final ow3 zam(Iterable iterable) {
    ...
    @ResultIgnorabilityUnspecified
    public final ow3 zan(GoogleApi googleApi) {
        zaaf zaafVar = new zaaf(googleApi.getApiKey());
        this.zar.sendMessage(this.zar.obtainMessage(14, zaafVar));
        return zaafVar.zab().a;
    }

    public final ow3 zao(GoogleApi googleApi, RegisterListenerMethod registerListenerMethod, UnregisterListenerMethod unregisterListenerMethod, Runnable runnable) {
        pw3 pw3Var = new pw3();
        zaJ(pw3Var, registerListenerMethod.zaa(), googleApi);
        this.zar.sendMessage(this.zar.obtainMessage(8, new zach(new zaf(new zaci(registerListenerMethod, unregisterListenerMethod, runnable), pw3Var), this.zam.get(), googleApi)));
        return pw3Var.a;
    }

    public final ow3 zap(GoogleApi googleApi, ListenerHolder.ListenerKey listenerKey, int i) {
        pw3 pw3Var = new pw3();
        zaJ(pw3Var, i, googleApi);
        this.zar.sendMessage(this.zar.obtainMessage(13, new zach(new zah(listenerKey, pw3Var), this.zam.get(), googleApi)));
        return pw3Var.a;
    }
    ...
    public final void zav(GoogleApi googleApi, int i, TaskApiCall taskApiCall, pw3 pw3Var, StatusExceptionMapper statusExceptionMapper) {
        zaJ(pw3Var, taskApiCall.zaa(), googleApi);
        this.zar.sendMessage(this.zar.obtainMessage(4, new zach(new zag(i, taskApiCall, pw3Var, statusExceptionMapper), this.zam.get(), googleApi)));
    }
