...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(di0.r(i, "Overread allowed size end=", new StringBuilder(String.valueOf(i).length() + 26)), parcel);
        }
    }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        sb.append(" got ");
        sb.append(size);
        throw new ParseException(di0.y(sb, " (0x", hexString, ")"), parcel);
    }
