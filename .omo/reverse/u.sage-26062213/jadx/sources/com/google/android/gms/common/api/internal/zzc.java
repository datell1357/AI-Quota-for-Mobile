...
final class zzc {
    private final Map zza = Collections.synchronizedMap(new di(0));
    private int zzb = 0;
    private Bundle zzc;
    ...
    public final void zzb(String str, LifecycleCallback lifecycleCallback) {
        ...
        if (map.containsKey(str)) {
            k21.f(di0.y(new StringBuilder(String.valueOf(str).length() + 59), "LifecycleCallback with tag ", str, " already added to this fragment."));
            return;
        }
        map.put(str, lifecycleCallback);
        if (this.zzb > 0) {
            new i05(Looper.getMainLooper()).post(new zzb(this, lifecycleCallback, str));
        }
    }
