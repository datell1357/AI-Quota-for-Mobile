    ...
    public final boolean zza() {
        try {
            ...
            if (!baseGmsClient.getServiceDescriptor().equals(interfaceDescriptor)) {
                ...
                Log.w("GmsClient", xw1.t(new StringBuilder(String.valueOf(serviceDescriptor).length() + 34 + String.valueOf(interfaceDescriptor).length()), "service descriptor mismatch: ", serviceDescriptor, " vs. ", interfaceDescriptor));
                return false;
            }
