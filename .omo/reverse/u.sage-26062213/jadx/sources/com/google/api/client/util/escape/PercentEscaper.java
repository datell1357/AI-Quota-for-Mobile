...
public class PercentEscaper extends UnicodeEscaper {
    ...
    public PercentEscaper(String str, boolean z) {
        if (str.matches(".*[0-9A-Za-z].*")) {
            k21.f("Alphanumeric ASCII characters are always 'safe' and should not be escaped.");
            throw null;
        }
        if (z && str.contains(" ")) {
            k21.f("plusForSpace cannot be specified when space is a 'safe' character");
            throw null;
        }
        if (str.contains("%")) {
            k21.f("The '%' character cannot be specified as 'safe'");
            throw null;
        }
        this.plusForSpace = z;
    ...
    public char[] escape(int i) {
        ...
        k21.f(di0.q(i, "Invalid unicode character value "));
        return null;
    }
