...
public class GoogleCredential extends Credential {
    ...
    public GoogleCredential(Builder builder) {
        super(builder);
        PrivateKey privateKey = builder.serviceAccountPrivateKey;
        String str = builder.serviceAccountId;
        if (privateKey == null) {
            Preconditions.checkArgument(str == null && builder.serviceAccountScopes == null && builder.serviceAccountUser == null);
            return;
        }
        this.serviceAccountId = (String) Preconditions.checkNotNull(str);
        this.serviceAccountProjectId = builder.serviceAccountProjectId;
        Collection<String> collection = builder.serviceAccountScopes;
        this.serviceAccountScopes = collection == null ? Collections.EMPTY_LIST : Collections.unmodifiableCollection(collection);
    ...
    public static GoogleCredential fromStream(InputStream inputStream, HttpTransport httpTransport, JsonFactory jsonFactory) throws IOException {
        ...
        if (str == null) {
            p61.k("Error reading credentials from stream, 'type' field not specified.");
            return null;
        }
        ...
        p61.k(di0.v("Error reading credentials from stream, 'type' value '", str, "' not recognized. Expecting 'authorized_user' or 'service_account'."));
        return null;
    }
    ...
    private static GoogleCredential fromStreamServiceAccount(GenericJson genericJson, HttpTransport httpTransport, JsonFactory jsonFactory) throws IOException {
        ...
        if (str == null || str2 == null || str3 == null || str4 == null) {
            p61.k("Error reading service account credential from stream, expecting  'client_id', 'client_email', 'private_key' and 'private_key_id'.");
            return null;
        }
    ...
    private static GoogleCredential fromStreamUser(GenericJson genericJson, HttpTransport httpTransport, JsonFactory jsonFactory) throws IOException {
        ...
        if (str == null || str2 == null || str3 == null) {
            p61.k("Error reading user credential from stream,  expecting 'client_id', 'client_secret' and 'refresh_token'.");
            return null;
        }
