...
public final /* synthetic */ class jy implements pe1 {
    public final /* synthetic */ int n;
    public final /* synthetic */ long o;

    public /* synthetic */ jy(long j, int i) {
        this.n = i;
        this.o = j;
    }
    ...
    public final Object k(Object obj) throws Exception {
        ...
        switch (i3) {
            case 0:
                ky kyVar = (ky) obj;
                pe1 pe1Var = kyVar.b;
                if (pe1Var != null && (o20Var = kyVar.a) != null) {
                    try {
                        f83Var = pe1Var.k(Long.valueOf(j));
                    } catch (Throwable th) {
                        f83Var = new f83(th);
                    }
                    o20Var.g(f83Var);
                ...
                return t64.a;
            case 1:
                ((hg2) obj).e(pj1.b, Long.valueOf(j));
                return null;
            default:
                jb3 jb3Var = (jb3) obj;
                jb3Var.getClass();
                pb3 pb3VarK0 = jb3Var.k0("SELECT * FROM workspec WHERE last_enqueue_time >= ? AND state IN (2, 3, 5) ORDER BY last_enqueue_time DESC");
                try {
                    pb3VarK0.h(1, j);
                    ...
                    while (pb3VarK0.c0()) {
                        ...
                        long j2 = pb3VarK0.getLong(iK7);
                        long j3 = pb3VarK0.getLong(iK8);
                        long j4 = pb3VarK0.getLong(iK9);
                        int i5 = (int) pb3VarK0.getLong(iK10);
                        jq jqVarC = ug4.c((int) pb3VarK0.getLong(iK11));
                        long j5 = pb3VarK0.getLong(iK12);
                        long j6 = pb3VarK0.getLong(iK13);
                        long j7 = pb3VarK0.getLong(iK14);
                        int i6 = iK15;
                        long j8 = pb3VarK0.getLong(i6);
                        int i7 = iK2;
                        int i8 = iK16;
                        int i9 = iK3;
                        ...
                        pb3Var = pb3VarK0;
                        try {
                            arrayList2.add(new og4(strO, cg4VarF, strO2, strO3, zl0VarS, zl0VarS2, j2, j3, j4, new lf0(tl2VarJ, zl2VarD, z2, z3, z4, ((int) pb3VarK0.getLong(i29)) != 0, pb3VarK0.getLong(i30), pb3VarK0.getLong(i31), ug4.a(pb3VarK0.getBlob(i32))), i5, jqVarC, j5, j6, j7, j8, z, jr2VarE, i13, i15, j9, i, i21, strO4, boolValueOf));
