...
public final class a54 extends ReplacementSpan {
    public final z44 o;
    public TextPaint r;
    ...
    public a54(z44 z44Var) {
        bi4.k(z44Var, "rasterizer cannot be null");
        this.o = z44Var;
    }
    ...
    */
    public final void draw(android.graphics.Canvas r19, java.lang.CharSequence r20, int r21, int r22, float r23, int r24, int r25, int r26, android.graphics.Paint r27) {
        /*
            ...
            goto L46
        L26:
            android.text.TextPaint r3 = r0.r
            if (r3 != 0) goto L31
        ...
        L94:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.a54.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        ...
        z44 z44Var = this.o;
        this.q = fAbs / (z44Var.b().b(14) != 0 ? ((ByteBuffer) r8.q).getShort(r1 + r8.n) : (short) 0);
        xc2 xc2VarB = z44Var.b();
        int iB = xc2VarB.b(14);
        if (iB != 0) {
            ((ByteBuffer) xc2VarB.q).getShort(iB + xc2VarB.n);
        }
        short s = (short) ((z44Var.b().b(12) != 0 ? ((ByteBuffer) r5.q).getShort(r7 + r5.n) : (short) 0) * this.q);
        this.p = s;
