...
public final class ch {
    ...
    public final int c(RectF rectF) {
        ...
        if (length == 0) {
            k21.n("No available text sizes to choose from.");
            return 0;
        }
        int i = length - 1;
        int i2 = 0;
        ...
        while (true) {
            ...
            StaticLayout staticLayoutA = yg.a(text, (Layout.Alignment) e(textView, Layout.Alignment.ALIGN_NORMAL, "getLayoutAlignment"), Math.round(rectF.right), maxLines, textView, this.h, this.k);
