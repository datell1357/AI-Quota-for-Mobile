...
public abstract class hy3 {
    ...
    public static void a(View view, Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i13.h);
        try {
    ...
    public static int b(Context context, int i) {
        ...
        k21.f("alpha must be between 0 and 255.");
        return 0;
    }
    ...
    public static ColorStateList d(Context context, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, iArr);
        try {
            if (!typedArrayObtainStyledAttributes.hasValue(0) || (resourceId = typedArrayObtainStyledAttributes.getResourceId(0, 0)) == 0 || (colorStateList = zf5.E(context, resourceId)) == null) {
