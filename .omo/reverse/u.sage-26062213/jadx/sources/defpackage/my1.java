...
public final class my1 {
    ...
    public my1(CharSequence charSequence, TextPaint textPaint, int i) {
        this.a = charSequence;
        this.b = textPaint;
        this.c = i;
    }
    ...
    public final BoringLayout.Metrics a() {
        if (!this.g) {
            TextDirectionHeuristic textDirectionHeuristicB = px3.b(this.c);
    ...
    public final CharSequence b() {
        ...
        if (charSequence2 instanceof Spanned) {
            ...
            if (is0.E(spanned, CharacterStyle.class)) {
    ...
    */
    public final float c() {
        ...
        L39:
            ...
            boolean r4 = defpackage.is0.E(r2, r4)
            if (r4 != 0) goto L5a
            java.lang.Class<b22> r4 = defpackage.b22.class
            boolean r2 = defpackage.is0.E(r2, r4)
            if (r2 != 0) goto L5a
        L51:
        ...
        L5d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.my1.c():float");
    }
}
