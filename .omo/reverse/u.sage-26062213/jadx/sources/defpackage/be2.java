...
public final class be2 {
    ...
    public final xh1 c(MotionEvent motionEvent, q9 q9Var) {
        int actionIndex;
        int actionMasked = motionEvent.getActionMasked();
        ...
        if (Build.VERSION.SDK_INT < 34 || motionEvent.getClassification() != 3) {
            ...
            while (i < pointerCount) {
                arrayList.add(d(q9Var, motionEvent, null, i, (z || i == actionIndex || (z2 && motionEvent.getButtonState() == 0)) ? false : true));
                i++;
            }
        } else {
            this.i = true;
            if (motionEvent.getActionMasked() == 0) {
                this.j = new go2((((long) Float.floatToRawIntBits(motionEvent.getRawY(0))) & 4294967295L) | (((long) Float.floatToRawIntBits(motionEvent.getRawX(0))) << 32));
            }
            arrayList.add(d(q9Var, motionEvent, this.j, 0, false));
        }
        ...
        return new xh1(arrayList, motionEvent);
    }
    ...
    */
    public final defpackage.bw2 d(defpackage.q9 r43, android.view.MotionEvent r44, defpackage.go2 r45, int r46, boolean r47) {
        /*
            Method dump skipped, instruction units count: 541
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.be2.d(q9, android.view.MotionEvent, go2, int, boolean):bw2");
    }
