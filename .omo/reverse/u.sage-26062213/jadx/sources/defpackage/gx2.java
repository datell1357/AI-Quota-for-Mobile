...
public final class gx2 {
    ...
    public gx2(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
        if (Build.VERSION.SDK_INT >= 29) {
            fx2.h(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
        }
        this.a = textPaint;
    ...
    public final boolean equals(Object obj) {
        ...
        gx2 gx2Var = (gx2) obj;
        int i = gx2Var.c;
        TextPaint textPaint = gx2Var.a;
        if (this.c != i || this.d != gx2Var.d) {
            return false;
        }
    ...
    public gx2(PrecomputedText.Params params) {
