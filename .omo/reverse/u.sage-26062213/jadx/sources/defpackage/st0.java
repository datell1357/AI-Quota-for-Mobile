...
public final class st0 extends a0 implements lo2 {
    public boolean A;
    public boolean B;
    ...
    public st0(Context context, Window window) {
        super(context);
        this.w = window;
        this.x = ca.A(la0.a);
        Field field = lb4.a;
        fb4.c(this, this);
        lb4.g(this, new uc(this, 1));
    }
    ...
    public final void a(int i, ag1 ag1Var) {
        ...
        if (ag1Var.N(i2 & 1, (i2 & 3) != 2)) {
            ((df1) this.x.getValue()).f(ag1Var, 0);
        } else {
            ag1Var.Q();
        }
        c33 c33VarR = ag1Var.r();
        if (c33VarR != null) {
            c33VarR.d = new z(this, i, 6);
        }
    }
    ...
    public final ke4 g(View view, ke4 ke4Var) {
        if (!this.z) {
            ...
            if (iMax != 0 || iMax2 != 0 || iMax3 != 0 || iMax4 != 0) {
                return ke4Var.a.r(iMax, iMax2, iMax3, iMax4);
            }
        }
        return ke4Var;
    }
    ...
    */
    public final void i(int r13, int r14) {
        ...
        Lb:
            ...
            r9 = 30
            if (r8 >= r9) goto L3b
            rf r8 = defpackage.rf.a
            int r8 = r8.a(r6)
            goto L4a
        L3b:
            r9 = 32
            if (r8 >= r9) goto L49
            wf r8 = defpackage.wf.a
            int r8 = r8.a(r6)
            goto L4a
        L46:
            int r8 = r3 + 1
        ...
        Lc7:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.st0.i(int, int):void");
    }
}
