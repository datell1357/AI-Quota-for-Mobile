# codex-usage-collection-recovery - Work Plan
...
- Evidence: .omo/evidence/task-<N>-codex-usage-collection-recovery.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-codex-usage-collection-recovery.<ext>
