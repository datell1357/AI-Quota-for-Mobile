# codex-stale-network-payload-recovery - Work Plan
...
- Evidence: .omo/evidence/task-<N>-codex-stale-network-payload-recovery.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-codex-stale-network-payload-recovery.<ext>
