...
AI Usage for Windows
  ├─ Provider collectors: Codex / Claude / Gemini / GitHub Copilot
...
- [ ] 모바일 앱에서 Codex/Claude/Gemini/Copilot Provider에 직접 로그인시키지 마
...
- [ ] PC upload token 저장 위치: Windows Credential Manager 권장 여부 확인
